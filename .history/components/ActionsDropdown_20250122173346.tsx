...
const ActionsDropdown = ({ file }: { file: Models.Document }) => {
  ...
  return (
    <div
      onClick={(e) => e.stopPropagation()} // Prevent click propagation to the parent card
    >
      <DropdownMenu
        open={isDropDownOpen}
      ...
      >
        <DropdownMenuTrigger asChild>
          <div
            onClick={(e) => e.stopPropagation()} // Prevent click propagation when opening the dropdown
          >
            <Image
